...
/**
 * Formats points still needed for a rank up with a leading plus and two
 * decimal places, e.g. 10.52 -> "+10.52".
 */
fun formatRankPoints(points: Double): String = "+%.2f".format(points)
